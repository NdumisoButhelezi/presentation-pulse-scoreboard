...
export function LoginForm() {
  ...
  const [registerData, setRegisterData] = useState({
    ...
    email: '',
    password: '',
    role: 'spectator' as 'judge' | 'spectator'
  });
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to Presentation Pulse Scoreboard.",
      });
    } catch (error: any) {
      toast({
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-secondary/30 to-primary/10 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-muted-foreground mt-2">Real-time scoring & leaderboards</p>
        </div>
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value: 'judge' | 'spectator') => 
